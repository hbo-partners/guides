...
Ce service est dédiée à la gestion de l'authentification des utilisateurs.
...
| id                | Description                                                              |
|:------------------|:-------------------------------------------------------------------------|
|`WWW_AUTH_1`        | Chaque push sur le projet `www-auth` déploie automatiquement le front   |
